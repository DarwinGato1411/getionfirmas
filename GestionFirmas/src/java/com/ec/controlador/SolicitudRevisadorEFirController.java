 ...
 * @author Darwin
 */
public class SolicitudRevisadorEFirController {
    ...
    private void cargarDatos() {
        listadoEstados = servicioEstadoProceso.finAllFirmas();

    }

    public SolicitudRevisadorEFirController() {
...
//            if (Messagebox.show("¿Desea modificar el registro, recuerde que debe crear las reteniones nuevamente?", "Atención", Messagebox.YES | Messagebox.NO, Messagebox.INFORMATION) == Messagebox.YES) {
    ...
    public List<EstadoFirma> getListadoEstados() {
        return listadoEstados;
    }

    public void setListadoEstados(List<EstadoFirma> listadoEstados) {
